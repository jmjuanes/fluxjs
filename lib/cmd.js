...
//Execute a command
module.exports.exec = function(cmd, wd, opt, cb)
{
  //Initialize the command options
  var options = { cwd: wd, encoding: opt.encoding, timeout: opt.timeout, maxBuffer: opt.max_buffer };
  ...
  return exec(cmd, options, function(error, stdout, stderr)
  {
    ...
    //Do the callback
    return cb(error, time_end - time_start, stdout, stderr);
  });
};
